...
Shader "Hidden/SeparableWeightedBlurDof34" {
	...
	v2f vertBilinear (appdata_img v) {
		v2f o;
		o.pos = UnityObjectToClipPos(v.vertex);
		o.uv.xy = UnityStereoScreenSpaceUVAdjust(v.texcoord.xy, _MainTex_ST);
		o.uv01 =  UnityStereoScreenSpaceUVAdjust(v.texcoord.xyxy + offsets.xyxy * half4(1.3846153846, 1.3846153846, -1.3846153846, -1.3846153846), _MainTex_ST);
		o.uv23 =  UnityStereoScreenSpaceUVAdjust(v.texcoord.xyxy + offsets.xyxy * half4(3.2307692308, 3.2307692308, -3.2307692308, -3.2307692308), _MainTex_ST);
		o.uv45 =  o.uv23;
	...
	half4 fragBlurBilinear (v2f i) : SV_Target {
		half4 blurredColor = half4 (0,0,0,0);
		...
		sampleA.rgb = sampleA.rgb * 0.2270270270; 
		sampleB.rgb = sampleB.rgb * 0.3162162162;
		sampleC.rgb = sampleC.rgb * 0.3162162162; 
		sampleD.rgb = sampleD.rgb * 0.0702702703; 
		sampleE.rgb = sampleE.rgb * 0.0702702703; 
...
Subshader {
  ...
  Pass {    
      ...
      #pragma vertex vertBilinear
      #pragma fragment fragBlurBilinear
      ENDCG
  }
}
