...
////// Emissive:
                ...
                float2 _DisTex01_UVpan_var = i.uv0 + float2(0, disTex01PanV);
                ...
                float disTex02PanV = _Time.g * _DisTex02_PanV;
                float2 _DisTex02_UVpan_var = i.uv0 + float2(0, disTex02PanV);
                ...
                float3 emissive = _InstensityA * ((_Tex01_Instensity * _Color_Tex01.rgb * _Tex01_var.rgb) + (_Tex02_Instensity * _Tex02_var.rgb * _Color_Tex02.rgb * _Color_Tex02.a)) * i.vertexColor.rgb;
                float alpha = i.vertexColor.a * _AlphaInstensityA * _Mask_Tex_var.r * 
                (lerp(dot(_Tex01_var, 1), _Tex01_var.a, _Tex01_RGBAlpha) + lerp(dot(_Tex02_var, 1), _Tex02_var.a, _Tex02_RGBAlpha));
